...
<!-- <p class="text-muted m-b-30 font-13">
  ...
  <br>
                      ...
                      <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                            <label>Father/Guardian/Spouse<span style="color:#FF0000;"> *</span></label>
                            <div class="row">
                               <div class="col-md-3"> 
                               ...
                               <div class="col-md-9"> <input type="text" required="required" name="father_name" placeholder="Enter Name"  id="brand_name" class="form-control" value="<?php echo getcustomer('father_name',$_REQUEST['banid']);?>"></div>
                            </div>
                             </div>
                         </div>
                         <br>
                         <div class="row">
                              <div class="col-md-6">
                            <label>Guarantor Title/Name<span style="color:#FF0000;"> *</span></label>
                            <div class="row">
                               <div class="col-md-3"> 
                               ...
                               <div class="col-md-9"> <input type="text" required="required" name="guarantor_name" placeholder="Enter Name"  id="brand_name" class="form-control" value="<?php echo getcustomer('guarantor_name',$_REQUEST['banid']);?>"></div>
                            </div>
                             </div>
                              <div class="col-md-6">
                            <label>Guarantor Father Title/Name<span style="color:#FF0000;"> *</span></label>
                            <div class="row">
                               <div class="col-md-3"> 
                               ...
                               <div class="col-md-9"> <input type="text" required="required" name="guarantor_father_name" placeholder="Enter Name"  id="brand_name" class="form-control" value="<?php echo getcustomer('guarantor_father_name',$_REQUEST['banid']);?>"></div>
                            </div>
                             </div>
                         </div><br>  <hr>
 ...
 <div class="col-md-6"> 
                            ...
                            <div class="col-md-6"> 
                              ...
                              <input type="text" name="cus_area" class="form-control" required="required" value="<?php echo getcustomer('cus_area',$_REQUEST['banid']);?>">
                              </div>  
                          </div>
                           <br>
                          <div class="row">
 <div class="col-md-6"> 
                              ...
                              <input type="text" name="cus_city" class="form-control" required="required" value="<?php echo getcustomer('cus_city',$_REQUEST['banid']);?>">
                              </div>  
                             
                          <div class="col-md-6">
                            <label>State<span style="color:#FF0000;"> *</span></label>
                           <input type="text" name="cus_state" required="required" placeholder="Enter State"  id="brand_name" class="form-control" value="<?php echo getcustomer('cus_state',$_REQUEST['banid']);?>">
                         </div>
                          </div>
                          <br>
                         <div class="row">
 <div class="col-md-6"> 
                              ...
                              <input type="text"  required="required" name="cus_pincode" class="form-control" value="<?php echo getcustomer('cus_pincode',$_REQUEST['banid']);?>">
                              </div>  
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-6"> 
                                  <label>Residence Type<span style="color:#FF0000;"> *</span></label>
                              <input type="text" required="required" name="gua_resident_type" class="form-control" value="<?php echo getcustomer('gua_resident_type',$_REQUEST['banid']);?>">
                              </div>  
                          </div>
                          <br>
                          <div class="row">
 <div class="col-md-6"> 
                                  <label>Door No . Street<span style="color:#FF0000;"> *</span></label>
                              <input type="text" required="required" name="gua_street" class="form-control" value="<?php echo getcustomer('gua_street',$_REQUEST['banid']);?>">
                              </div> 
                            <div class="col-md-6"> 
                                  <label>Area<span style="color:#FF0000;"> *</span></label>
 ...
 <div class="col-md-6"> 
                                  <label>City<span style="color:#FF0000;"> *</span></label>
                              <input type="text" name="gua_city" class="form-control" required="required" value="<?php echo getcustomer('gua_city',$_REQUEST['banid']);?>">
                              </div>  
                             
                          <div class="col-md-6">
                            <label>State<span style="color:#FF0000;"> *</span></label>
                           <input type="text" name="gua_street" required="required" placeholder="Enter State"  class="form-control" value="<?php echo getcustomer('gua_street',$_REQUEST['banid']);?>">
                         </div>
                          </div>
                          <br>
                         <div class="row">
 <div class="col-md-6"> 
                                  <label>Pincode<span style="color:#FF0000;"> *</span></label>
                              <input type="text"  required="required" name="gua_pincode" class="form-control" value="<?php echo getcustomer('gua_pincode',$_REQUEST['banid']);?>">
                              </div>  
                             
                          <div class="col-md-6">
                            <label>Land Mark<span style="color:#FF0000;"> *</span></label>
                           <input type="text" required="required" name="gua_landmark" placeholder="Enter Landmark"  id="brand_name" class="form-control" value="<?php echo getcustomer('gua_landmark',$_REQUEST['banid']);?>">
                         </div>
                          </div>
                          <br>
                          ...
                          <div class="row">
                             <div class="col-md-6">
                            <label>Phone<span style="color:#FF0000;"> *</span></label>
                           <input type="number" required="required" name="gua_phone" placeholder="Enter Alternative Mobileno"  id="brand_name" class="form-control"  value="<?php echo getcustomer('gua_phone',$_REQUEST['banid']);?>">
                           </div>
                            
                          <div class="col-md-6">
                            <label>Cell Phone<span style="color:#FF0000;"> *</span></label>
                           <input type="number" required="required" name="gua_cellphone" placeholder="Enter Mobileno"  id="brand_name" class="form-control"  value="<?php echo getcustomer('gua_cellphone',$_REQUEST['banid']);?>">
                           </div>
...
<textarea name="applicant_address" class="form-control"><?php echo $coapplicantlist['applicant_address']; ?></textarea>                         </div>
  ...
  <div class="panel panel-info">
   ...
   <div class="row">
     <div class="col-md-6">
                            <label>Fair Market Value<span style="color:#FF0000;"> *</span></label>
                           <input type="text" required="required" name="fair_market" placeholder="Enter Fair Market Value"  value="<?php echo getcustomer('fair_market',$_REQUEST['banid']);?>" id="brand_name" class="form-control">
                           </div>
                          <div class="col-md-6">
