            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/expense_type.htm"><button type="button" class="btn btn-default">Back to Listings Page</button>
                        </a>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Expense Type List</li>
...
<!-- <p class="text-muted m-b-30 font-13">
  ...
  <br>
                          ...
                          <div class="row">
							...
							<input type="text" name="expense_type" class="form-control" required="required" value="<?php echo getexpensetype('expense_type', $_REQUEST['banid']); ?>">
                            </div>
