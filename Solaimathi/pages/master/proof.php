...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Proof(s)"))
            {
                return true;
            }
            else
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                     <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/addproof.htm"><button type="button" class="btn btn-default">Add New</button></a>                        
                    </div>
            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Proofs</h4>
                 ...
                 <form name="form1" method="post" action="">
                                ...
                                <tr align="center">
                                    <th style="width:5%;">S.id</th>
                                     <th style="text-align: left;">Proof Name</th>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editproof.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
		...
		"sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=prooftable"
    });
</script>
