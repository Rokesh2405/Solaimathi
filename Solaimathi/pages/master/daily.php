...
<div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/adddaily.htm"><button type="button" class="btn btn-default">Add New</button></a>                        
                    </div>
                    
                 
                  <h4 class="page-title">Daily Installment</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $sitename; ?>"><?php echo getusers('name',$_SESSION['GRUID']); ?></a></li>
                        <li class="breadcrumb-item active">Daily Installment List</li>
                    </ol>
                </div>
</div>
...
{
var did = a;
window.location.href = '<?php echo $sitename; ?>master/' + a + '/editdaily.htm';
}     
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=dailytable"
    });
</script>