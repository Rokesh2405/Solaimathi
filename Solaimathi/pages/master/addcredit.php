...
if (isset($_REQUEST['submit'])) {
    ...
    $msg = addcredit($ledger_name,$ledger_type,$customer_name,$other,$amount,$description,$modeofpayment,$cheque_no,$transfer_id,$getid);
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/creditlist.htm"><button type="button" class="btn btn-default">Back to Listings Page</button>
                        </a>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Credit List</li>
...
<?php $sel = pFETCH("SELECT * FROM `customer` WHERE `status`=?", 1);
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo $sitename; ?>master/creditlist.htm">Back to Listings page</a>
                        </div>
