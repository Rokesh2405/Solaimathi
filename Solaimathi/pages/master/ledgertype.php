...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Ledger Type(s)"))
            {
                return true;
            }
            else
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                     <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/addledgertype.htm"><button type="button" class="btn btn-default">Add New</button></a>                        
                    </div>
                  <h4 class="page-title">Ledger Type</h4>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Ledger Type</li>
                    </ol>
                </div>
</div>
                <!-- /.box-header -->
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Ledger Types</h4>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editledgertype.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
		...
		"sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=ledgertypetable"
    });
</script>
