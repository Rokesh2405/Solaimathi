            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                     <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/addsubuser.htm"><button type="button" class="btn btn-default">Add New</button></a>                   
                    </div>
                  <h4 class="page-title">Cash Collection</h4>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Cash Collection List</li>
                    </ol>
                </div>
</div>
                <!-- /.box-header -->
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editsubuser.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=subusertable"
    });
</script>
