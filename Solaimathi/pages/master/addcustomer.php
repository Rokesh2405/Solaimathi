...
<!-- <p class="text-muted m-b-30 font-13">
  ...
  <br>
                          ...
                          <div class="row">
                           ...
                           <input type="date" required="required" name="application_date" placeholder="Enter Name"  id="application_date" class="form-control" value="<?php if(getcustomer('application_date',$_REQUEST['banid'])!=''){ echo getcustomer('application_date',$_REQUEST['banid']); } ?>">
                            
                            
                          </div>
                         <!--  <div class="col-md-6">
                            <label>Service Centre<span style="color:#FF0000;"> *</span></label>
                           <input type="text" required="required" name="service_centre" placeholder="Enter Service Centre Name"  id="service_centre" class="form-control" value="<?php echo getcustomer('service_centre',$_REQUEST['banid']);?>">
                    </div> -->
                      </div>
                      <br>
                      <div class="row">
                              <div class="col-md-6">
                            <label>Customer Title / Name<span style="color:#FF0000;"> *</span></label>
                            <div class="row">
                               <div class="col-md-3"> <select class="form-control" name="customer_title">
                                <option value="Mr" <?php if(getcustomer('customer_title',$_REQUEST['banid'])=='Mr') { ?> selected="selected" <?php } ?>>Mr</option>
                                <option value="Miss" <?php if(getcustomer('customer_title',$_REQUEST['banid'])=='Miss') { ?> selected="selected" <?php } ?>>Miss</option>
                                <option value="Mrs" <?php if(getcustomer('customer_title',$_REQUEST['banid'])=='Mrs') { ?> selected="selected" <?php } ?>>Mrs</option>
                            </select></div>     
                               <div class="col-md-9"> <input type="text" required="required" name="name" placeholder="Enter Name"  id="brand_name" class="form-control" value="<?php echo getcustomer('name',$_REQUEST['banid']);?>"></div>
                            </div>
                             </div>
                              <div class="col-md-6">
                            <label>Father/Guardian/Spouse</label>
                            <div class="row">
                               <div class="col-md-3"> 
                                <select class="form-control" name="father_title">
                                <option value="Mr" <?php if(getcustomer('father_title',$_REQUEST['banid'])=='Mr') { ?> selected="selected" <?php } ?>>Mr</option>
                                <option value="Miss" <?php if(getcustomer('father_title',$_REQUEST['banid'])=='Miss') { ?> selected="selected" <?php } ?>>Miss</option>
                                <option value="Mrs" <?php if(getcustomer('father_title',$_REQUEST['banid'])=='Mrs') { ?> selected="selected" <?php } ?>>Mrs</option>
                            </select></div>     
                               <div class="col-md-9"> <input type="text" name="father_name" placeholder="Enter Name"  id="brand_name" class="form-control" value="<?php echo getcustomer('father_name',$_REQUEST['banid']);?>"></div>
                            </div>
                             </div>
                         </div>
                         <br>
                         <div class="row">
                              <div class="col-md-6">
                            <label>Guarantor Title/Name</label>
                            <div class="row">
                               <div class="col-md-3"> 
                                <select class="form-control" name="guarantor_title">
                                <option value="Mr" <?php if(getcustomer('guarantor_title',$_REQUEST['banid'])=='Mr') { ?> selected="selected" <?php } ?>>Mr</option>
                                <option value="Miss" <?php if(getcustomer('guarantor_title',$_REQUEST['banid'])=='Mr') { ?> selected="selected" <?php } ?>>Miss</option>
                                <option value="Mrs" <?php if(getcustomer('guarantor_title',$_REQUEST['banid'])=='Mr') { ?> selected="selected" <?php } ?>>Mrs</option>
                            </select></div>     
                               <div class="col-md-9"> <input type="text" name="guarantor_name" placeholder="Enter Name"  id="brand_name" class="form-control" value="<?php echo getcustomer('guarantor_name',$_REQUEST['banid']);?>"></div>
                            </div>
                             </div>
                              <div class="col-md-6">
                            <label>Guarantor Father Title/Name</label>
                            <div class="row">
                               <div class="col-md-3"> 
                                <select class="form-control" name="guarantor_father_title">
                                <option value="Mr" <?php if(getcustomer('guarantor_father_title',$_REQUEST['banid'])=='Mr') { ?> selected="selected" <?php } ?>>Mr</option>
                                <option value="Miss" <?php if(getcustomer('guarantor_father_title',$_REQUEST['banid'])=='Miss') { ?> selected="selected" <?php } ?>>Miss</option>
                                <option value="Mrs" <?php if(getcustomer('guarantor_father_title',$_REQUEST['banid'])=='Mrs') { ?> selected="selected" <?php } ?>>Mrs</option>
                            </select></div>     
                               <div class="col-md-9"> <input type="text" name="guarantor_father_name" placeholder="Enter Name"  id="brand_name" class="form-control" value="<?php echo getcustomer('guarantor_father_name',$_REQUEST['banid']);?>"></div>
                            </div>
                             </div>
                         </div><br>  <hr>
                            <h4>Applicant Residence Details</h4>
                            <hr>
                            <br>
                         <div class="row">

                            <div class="col-md-6"> 
                                  <label>Residence Type<span style="color:#FF0000;"> *</span></label>
                              <input type="text" required="required" name="residence_type" class="form-control" value="<?php echo getcustomer('residence_type',$_REQUEST['banid']);?>">
                              </div>  
                          </div>
                          <br>
                          <div class="row">
 <div class="col-md-6"> 
                              ...
                              <input type="text" required="required" name="cus_street" class="form-control" value="<?php echo getcustomer('cus_street',$_REQUEST['banid']);?>">
                              </div> 
                            <div class="col-md-6"> 
                                  <label>Area</label>
                              <input type="text" name="cus_area" class="form-control" value="<?php echo getcustomer('cus_area',$_REQUEST['banid']);?>">
                              </div>  
                          </div>
                           <br>
                          <div class="row">
 <div class="col-md-6"> 
                                  <label>City</label>
                              <input type="text" name="cus_city" class="form-control" value="<?php echo getcustomer('cus_city',$_REQUEST['banid']);?>">
                              </div>  
                             
                          <div class="col-md-6">
                            <label>State</label>
                           <input type="text" name="cus_state" placeholder="Enter State"  id="brand_name" class="form-control" value="<?php echo getcustomer('cus_state',$_REQUEST['banid']);?>">
                         </div>
                          </div>
                          <br>
                         <div class="row">
 <div class="col-md-6"> 
                                  <label>Pincode</label>
                              <input type="text" name="cus_pincode" class="form-control" value="<?php echo getcustomer('cus_pincode',$_REQUEST['banid']);?>">
                              </div>  
                             
                          <div class="col-md-6">
                            <label>Land Mark<span style="color:#FF0000;"> *</span></label>
                           <input type="text" required="required" name="cus_landmark" placeholder="Enter Landmark"  id="brand_name" class="form-control" value="<?php echo getcustomer('cus_landmark',$_REQUEST['banid']);?>">
                         </div>
                          </div>
                          <br>
                          ...
                          <div class="row">
                           ...
                           <input type="number" required="required" name="alt_mobileno" placeholder="Enter Alternative Mobileno"  id="brand_name" class="form-control"  value="<?php echo getcustomer('alt_mobileno',$_REQUEST['banid']);?>">
                           </div>
                            
                          <div class="col-md-6">
                            <label>Cell Phone<span style="color:#FF0000;"> *</span></label>
                           <input type="number" required="required" name="mobileno" placeholder="Enter Mobileno"  id="brand_name" class="form-control"  value="<?php echo getcustomer('mobileno',$_REQUEST['banid']);?>">
                            ...
                            <br>  <hr>
                            <h4>Guarantor Residence Details</h4>
                            <hr>
                            <br>
                         <div class="row">
                            ...
                            <div class="col-md-6"> 
                              ...
                              <input type="text" name="gua_resident_type" class="form-control" value="<?php echo getcustomer('gua_resident_type',$_REQUEST['banid']);?>">
                              </div>  
                          </div>
                          <br>
                          <div class="row">
 <div class="col-md-6"> 
                              ...
                              <input type="text" name="gua_street" class="form-control" value="<?php echo getcustomer('gua_street',$_REQUEST['banid']);?>">
                              </div> 
                            <div class="col-md-6"> 
                                  <label>Area<span style="color:#FF0000;"> *</span></label>
                              <input type="text" name="gua_area" class="form-control" required="required" value="<?php echo getcustomer('gua_area',$_REQUEST['banid']);?>">
                              </div>  
                          </div>
                           <br>
                          <div class="row">
 <div class="col-md-6"> 
                                  <label>City</label>
                              <input type="text" name="gua_city" class="form-control" value="<?php echo getcustomer('gua_city',$_REQUEST['banid']);?>">
                              </div>  
                             
                          <div class="col-md-6">
                            <label>State</label>
                           <input type="text" name="gua_street"  placeholder="Enter State"  class="form-control" value="<?php echo getcustomer('gua_street',$_REQUEST['banid']);?>">
                         </div>
                          </div>
                          <br>
                         <div class="row">
 <div class="col-md-6"> 
                                  <label>Pincode</label>
                              <input type="text" name="gua_pincode" class="form-control" value="<?php echo getcustomer('gua_pincode',$_REQUEST['banid']);?>">
                              </div>  
                             
                          <div class="col-md-6">
                            <label>Land Mark</label>
                           <input type="text" name="gua_landmark" placeholder="Enter Landmark"  id="brand_name" class="form-control" value="<?php echo getcustomer('gua_landmark',$_REQUEST['banid']);?>">
                         </div>
                          </div>
                          <br>
                          ...
                          <div class="row">
                             <div class="col-md-6">
                            <label>Phone</label>
                           <input type="number" name="gua_phone" placeholder="Enter Alternative Mobileno"  id="brand_name" class="form-control"  value="<?php echo getcustomer('gua_phone',$_REQUEST['banid']);?>">
                           </div>
                            
                          <div class="col-md-6">
                            <label>Cell Phone</label>
                           <input type="number" name="gua_cellphone" placeholder="Enter Mobileno"  id="brand_name" class="form-control"  value="<?php echo getcustomer('gua_cellphone',$_REQUEST['banid']);?>">
                           </div>
                   ...
                   <div class="col-md-6">
                           ...
                           <input type="text" required="required" name="contract_name" placeholder="Enter Contract Name"  id="brand_name" class="form-control"  value="<?php echo getcustomer('contract_name',$_REQUEST['banid']);?>">
                           </div>
                           <div class="col-md-6">
                            <label>Vehicle No<span style="color:#FF0000;"> *</span></label>
                           <input type="text" required="required" name="cvehicle_no" placeholder="Enter Vehicle Number" class="form-control"  value="<?php echo getcustomer('cvehicle_no',$_REQUEST['banid']);?>">
                           </div>
                            </div>
                            <br>
 <div class="row">
                   <div class="col-md-6">
                            <label>Contract No<span style="color:#FF0000;"> *</span></label>
                           <input type="text" required="required" name="contract_no" placeholder="Enter Contract No"  id="brand_name" class="form-control"  value="<?php echo getcustomer('contract_no',$_REQUEST['banid']);?>">
                           </div>
                       </div>
                       <br> -->
                       <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                         ...
                         <select name="vehicle_type" class="form-control" onchange="getvehicle(this.value);">
                            ...
                            <div class="col-md-6" <?php if(getcustomer('vehicle_type', $_REQUEST['banid'])=='1' || getcustomer('vehicle_type', $_REQUEST['banid'])=='2') { ?>  style="display:block;" <?php } else { ?>  style="display:none;" <?php } ?> id="loansec9">
                            <label>Reg No</label>
                           <input type="text" name="regno" placeholder="Enter Reg No" value="<?php echo getcustomer('regno',$_REQUEST['banid']);?>" id="brand_name" class="form-control">
                           </div>
                       </div>
                           
                            <div class="row">

<div class="col-md-6" <?php if(getcustomer('vehicle_type', $_REQUEST['banid'])=='1' || getcustomer('vehicle_type', $_REQUEST['banid'])=='2') { ?>  style="display:block;" <?php } else { ?>  style="display:none;" <?php } ?> id="loansec3">
                            <label>Make</label>
                           <input type="text" name="make" placeholder="Enter Make" value="<?php echo getcustomer('make',$_REQUEST['banid']);?>" id="brand_name" class="form-control">
                           </div>
<div class="col-md-6" <?php if(getcustomer('vehicle_type', $_REQUEST['banid'])=='1' || getcustomer('vehicle_type', $_REQUEST['banid'])=='2') { ?>  style="display:block;" <?php } else { ?>  style="display:none;" <?php } ?> id="loansec4">
                            <label>Color</label>
                           <input type="text" name="color" placeholder="Enter Color" value="<?php echo getcustomer('color',$_REQUEST['banid']);?>" id="brand_name" class="form-control">
                           </div>
                            </div>
                          

                            <div class="row">
                             <div class="col-md-6" <?php if(getcustomer('vehicle_type', $_REQUEST['banid'])=='1' || getcustomer('vehicle_type', $_REQUEST['banid'])=='2') { ?>  style="display:block;" <?php } else { ?>  style="display:none;" <?php } ?> id="loansec5">
                            <label>No of Owners</label>
                           <input type="number" name="noof_owners" placeholder="Enter No of Owners" value="<?php echo getcustomer('noof_owners',$_REQUEST['banid']);?>" id="brand_name" class="form-control">
                           </div>
                             <div class="col-md-6" <?php if(getcustomer('vehicle_type', $_REQUEST['banid'])=='1' || getcustomer('vehicle_type', $_REQUEST['banid'])=='2') { ?>  style="display:block;" <?php } else { ?>  style="display:none;" <?php } ?> id="loansec6">
                            <label>Vehicle</label>
                            <select name="vehicle" class="form-control">
                                <option value="Old" <?php if(getcustomer('vehicletype',$_REQUEST['banid'])=='Old') { ?> selected="selected" <?php } ?>>Old</option>
                                <option value="New" <?php if(getcustomer('vehicletype',$_REQUEST['banid'])=='New') { ?> selected="selected" <?php } ?>>New</option>
                         </select>
                         ...
                         <select name="vehicle_name" id="vehicle_name" class="form-control" onchange="getmodel(this.value);">
                            <option value="">Select</option>
                            <?php
                            if(getcustomer('vehicle_type', $_REQUEST['banid'])!='') {
                            $vehitype=getcustomer('vehicle_type', $_REQUEST['banid']);
               ...
               while ($fdepart = $sel->fetch(PDO::FETCH_ASSOC)) {
                            ?>
                            <option value="<?php echo $fdepart['id']; ?>" <?php if(getcustomer('vehicle_model', $_REQUEST['banid'])==$fdepart['id']) { ?> selected="selected" <?php } ?>><?php echo $fdepart['model_name']; ?></option>
                            <?php } } ?>
                            </select>
                           ...
                           <div class="row">
                                                          <div class="col-md-6" <?php if(getcustomer('vehicle_type', $_REQUEST['banid'])=='1' || getcustomer('vehicle_type', $_REQUEST['banid'])=='2') { ?>  style="display:block;" <?php } else { ?>  style="display:none;" <?php } ?> id="loansec7">
                            <label>Having Insurance ? </label>
                            <select name="having_insurance" class="form-control" onchange="getins(this.value);">
                            <option value="">Select</option>
...
<br>
             <div class="row" <?php if(getcustomer('having_insurance',$_REQUEST['banid'])=='1') { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?> id="insur2">
                           ...
                           <input  type="file" value="<?php echo getcustomer('insurance_proof', $_REQUEST['banid']); ?>" <?php if(getcustomer('insurance_proof', $_REQUEST['banid'])=='') { ?> <?php } ?> name="insurance_proof" class="form-control" >
               ...
               <?php } ?>
                           ...
                           <input  type="file" value="<?php echo getcustomer('proof', $_REQUEST['banid']); ?>" name="proof" class="form-control" >
                   ...
                   <?php if (getcustomer('proof', $_REQUEST['banid']) != '') { ?>
                    ...
                    <?php } ?>
                        ...
                        <br>
                           ...
                           <input  type="file" value="<?php echo getcustomer('cuphoto', $_REQUEST['banid']); ?>" <?php if(getcustomer('cuphoto', $_REQUEST['banid'])=='') { ?> <?php } ?> name="cuphoto" class="form-control" >
                   ...
                   <?php if (getcustomer('cuphoto', $_REQUEST['banid']) != '') { ?>
                    ...
                    <?php } ?>
                        ...
                        <br>
                    <div class="row">
                           <div class="col-md-6" <?php if(getcustomer('vehicle_type', $_REQUEST['banid'])=='1' || getcustomer('vehicle_type', $_REQUEST['banid'])=='2') { ?>  style="display:block;" <?php } else { ?>  style="display:none;" <?php } ?> id="loansec8">
                            <label>Bike Photo <span style="color:#FF0000;"> *(Recommended Size 600 Pixels Width and 600 Pixels Height)</span></label>
                           <input  type="file" value="<?php echo getcustomer('bikephoto', $_REQUEST['banid']); ?>"name="bikephoto" class="form-control" >
...
<textarea name="proof_details" class="form-control"><?php echo getcustomer('proof_details', $_REQUEST['banid']); ?></textarea>                          
                 </div>
                            <div class="col-md-6">
                            <label>Address</label>
<textarea name="address" class="form-control"><?php echo getcustomer('address', $_REQUEST['banid']); ?></textarea>                          
                 </div>
                 </div>
                      <br>
                           <div class="row">
                           ...
                           <input type="text" name="applicant_name" placeholder="Enter Name" value="<?php echo getcustomer('applicant_name',$_REQUEST['banid']);?>" id="insurance_amount" class="form-control">                                                             
                                                                    ...
                                                                    <div class="col-md-6">
                                                                    <label>Co Applicant Contact No</label>
                        ...
                        <div class="row">
                                                                    <div class="col-md-6">
                                                                    <label>Co Applicant Proof Type</label>
...
<?php
               ...
               <?php } ?>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                    <label>Co Applicant Proof</label>
                          <input type="file" name="applicant_proof" class="form-control">
                          
                          </div>
                                                                    </div>  <br>             <div class="row">
                                                                    <div class="col-md-6"><label>Co Applicant Address</label>
<textarea name="applicant_address" class="form-control"><?php echo $coapplicantlist['applicant_address']; ?></textarea>                         </div>
  ...
  <div class="panel panel-info">
                                                        <div class="panel-heading">
                                                            <div class="panel-title">Deals Details</div>
                                                        </div>
                                                        <div class="panel-body">

   <div class="row">
     <div class="col-md-6" <?php if(getcustomer('vehicle_type', $_REQUEST['banid'])=='1' || getcustomer('vehicle_type', $_REQUEST['banid'])=='2') { ?>  style="display:block;" <?php } else { ?>  style="display:none;" <?php } ?> id="loansec10">
                            <label>Fair Market Value</label>
                           <input type="text" name="fair_market" placeholder="Enter Fair Market Value"  value="<?php echo getcustomer('fair_market',$_REQUEST['banid']);?>" id="brand_name" class="form-control">
                           </div>
                          <div class="col-md-6">
                            <label>Loan Amount<span style="color:#FF0000;"> *</span></label>
                           <input type="text" required="required" name="loan_amount" id="loan_amount" placeholder="Enter Loan Amount"  value="<?php echo getcustomer('loan_amount',$_REQUEST['banid']);?>" id="brand_name" class="form-control">
                           </div>
                           </div>
                           <br>
                           <div class="row">
                             <div class="col-md-6">
                            <label id="inname">
<?php if(getcustomer('vehicle_type',$_REQUEST['banid'])=='1' || getcustomer('vehicle_type',$_REQUEST['banid'])=='2' ) { ?>Interest Percentage<?php } else { ?>Initial Interest Amount<?php } ?>
                                <span style="color:#FF0000;"> *</span></label>
                         <input type="text" name="interest_percentage" id="interest_percentage" class="form-control" required="required" placeholder="Enter the Interest Percentage" value="<?php echo getcustomer('interest_percentage', $_REQUEST['banid']); ?>">
                         ...
                         <input type="text" name="months" class="form-control" placeholder="Enter the No of Months" value="<?php echo getcustomer('due_amt_per_month', $_REQUEST['banid']); ?>">
                          ...
                          <div class="col-md-6" <?php if(getcustomer('vehicle_type',$_REQUEST['banid'])=='1' || getcustomer('vehicle_type',$_REQUEST['banid'])=='2') { ?>style="display:block;" <?php } else { ?> style="display:none;" <?php } ?> id="bikesec2">
                           ...
                           <input type="number"  name="noof_month_due" id="noof_month_due" placeholder="Enter No of Month Due"  value="<?php echo getcustomer('noof_month_due',$_REQUEST['banid']);?>" id="brand_name" class="form-control">
                           </div>
                           ...
                           <input readonly="readonly" name="due_amt_per_month" id="due_amt_per_month" placeholder="Enter Due Amount Per Month"  id="brand_name" class="form-control" value="<?php echo getcustomer('due_amt_per_month',$_REQUEST['banid']);?>">
                           </div>
                            ...
                            <br>
                            <!-- <div class="row">
                              <div class="col-md-6" <?php if(getcustomer('vehicle_type',$_REQUEST['banid'])!='1' && getcustomer('vehicle_type',$_REQUEST['banid'])!='2') { ?>style="display:block;" <?php } else { ?> style="display:none;" <?php } ?> id="bikesec4">
                                  <label>No of Installments<span style="color:#FF0000;"> *</span></label>
                           <input type="text" required="required" name="no_of_installment" placeholder="Enter No of Installments"  value="<?php echo getcustomer('no_of_installment',$_REQUEST['banid']);?>" id="brand_name" class="form-control">
...
<script type="text/javascript">
      $("#noof_month_due").keyup(function(){
    loanamount=$("#loan_amount").val();
    interest=$("#interest_percentage").val();
    noof_month_due=$(this).val();
    peramt=Number(loanamount)/Number(noof_month_due);
    interestamt=Number(peramt)*(Number(interest)/100);
    finalamt=Number(peramt)+Number(interestamt);
    $("#due_amt_per_month").val(finalamt);
    });
    $("#interest_percentage").keyup(function(){
    loanamount=$("#loan_amount").val();
    noof_month_due=$("#noof_month_due").val();
    interest=$(this).val();
    peramt=Number(loanamount)/Number(noof_month_due);
    interestamt=Number(peramt)*(Number(interest)/100);
    finalamt=Number(peramt)+Number(interestamt);
...
function getmodel(a){
 ...
 function getvehicle(a)
    {
        if(a=='1' || a=='2'){
            $("#inname").html('Interest Percentage');
            $("#bikesec2").css("display", "block");
            $("#bikesec3").css("display", "block");
            $("#bikesec4").css("display", "block");
            ...
            $("#loansec3").css("display", "block");
            $("#loansec4").css("display", "block");
            $("#loansec5").css("display", "block");
            $("#loansec6").css("display", "block");
             $("#loansec7").css("display", "block");
               $("#loansec8").css("display", "block");
                $("#loansec9").css("display", "block");
                     $("#loansec10").css("display", "block");
        }
        else if(a==3) {
            $("#inname").html('Initial Interest Amount');
            $("#loansec1").css("display", "none");
            $("#loansec2").css("display", "none");
            $("#loansec3").css("display", "none");
            $("#loansec4").css("display", "none");
            $("#loansec5").css("display", "none");
            $("#loansec6").css("display", "none");
             $("#loansec7").css("display", "none");
              $("#loansec8").css("display", "none");
               $("#loansec9").css("display", "none");
                $("#loansec10").css("display", "none");
            $("#bikesec2").css("display", "none");
            $("#bikesec3").css("display", "none");
            $("#bikesec4").css("display", "none");
