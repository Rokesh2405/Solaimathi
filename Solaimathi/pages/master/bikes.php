...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Vehicle(s)"))
            {
                return true;
            }
            else
...
<style type="text/css">
    .row { margin:0;}
    #normalexamples tbody tr td:nth-child(6),tbody tr td:nth-child(5) {
        text-align:center;
    }
</style>
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                     <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/addbike.htm"><button type="button" class="btn btn-default">Add New</button></a>                        
                    </div>
                  <h4 class="page-title">Vehicle Name</h4>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Vehicles</h4>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editbike.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=biketable"
    });
</script>
