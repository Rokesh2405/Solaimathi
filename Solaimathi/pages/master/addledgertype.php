...
if (isset($_REQUEST['submit'])) {
    ...
    $msg = addledgertype($ledgername,$ledgertype,$status,$getid);
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Ledger Type List</li>
  ...
  <br>
                          ...
                          <div class="row">
							...
							<select name="ledgername" class="form-control">
                                ...
                                <?php
                                if ($fdepart['id'] == getledgertype('ledgername', $_REQUEST['banid'])) {
                            ...
                            <input type="text" name="ledgertype" class="form-control" required="required" value="<?php echo getledgertype('ledgertype', $_REQUEST['banid']); ?>">
                            </div>
                            </div>
                            <br>
                            <div class="row">
                         ...
                         <option value="1" <?php if(getledgertype('status', $_REQUEST['banid'])=='1') { ?> selected="selected"<?php } ?>>Active</option>      
                         <option value="0" <?php if(getledgertype('status', $_REQUEST['banid'])=='0') { ?> selected="selected"<?php } ?>>Inactive</option>      
                          </select>
                      </div> 
