...
<style type="text/css">
    .row { margin:0;}
    #normalexamples tbody tr td:nth-child(1),tbody tr td:nth-child(3), tbody tr td:nth-child(4),tbody tr td:nth-child(5),tbody tr td:nth-child(6),tbody tr td:nth-child(7) ,tbody tr td:nth-child(8),tbody tr td:nth-child(10){
        text-align:center;
    }
</style>
...
<div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/addmonthly.htm"><button type="button" class="btn btn-default">Add New</button></a>                        
                    </div>
                    
                 
                  <h4 class="page-title">Monthly Installment</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $sitename; ?>"><?php echo getusers('name',$_SESSION['GRUID']); ?></a></li>
                        <li class="breadcrumb-item active">Monthly Installment List</li>
                    </ol>
                </div>
</div>
            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Installment</h4>
...
{
var did = a;
window.location.href = '<?php echo $sitename; ?>master/' + a + '/editmonthly.htm';
}     
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=monthlytable"
    });
</script>