            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/weekly.htm"><button type="button" class="btn btn-default">Back to Listings Page</button>
                        </a>
                    ...
                    <h4 class="page-title"><?php
                        ...
                        ?> Weekly Installment</h4>
                    <ol class="breadcrumb">
                      
                        <li class="breadcrumb-item"> Weekly Installment List</li>
  ...
  <br>
                                        ...
                                        <div class="box-body">
											...
											$loanamt=$getrecd['loan_amount']/$getrecd['due_amt_per_month'];
											 ...
											 $getrecd = FETCH_all("SELECT * FROM customer WHERE (`name` LIKE '%".$cusid."%') OR (`mobileno`='".$cusid."') AND `vehicle_type`='4' AND `id`!=? ORDER BY `id` DESC", '0');
											 if($getrecd['vehicle_type']=='1' || $getrecd['vehicle_type']=='2'){
											 $loanamt= $getrecd['due_amt_per_month'];
											}
											else
...
$("#cusname").keyup(function(){
 ...
 $.ajax({
            ...
            data: {searchkey: searchkey,vehicle_type:4},
            success: function (data) {
...
$("#amount").keyup(function(){
 ...
 $.ajax({
            url: "<?php echo $sitename; ?>ajaxfunction.php",
            data: {cusid: cusid,vehicle_type:4,incval:1,amount:amount},
            success: function (data) {
			var result = data.split('#');
