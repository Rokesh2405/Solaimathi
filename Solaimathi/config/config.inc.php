...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    $db = new PDO('mysql:host=localhost;dbname=solaimathi;charset=utf8mb4', 'root', '');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $sitename = 'http://localhost/ttbilling/solaimathi/';
    $fsitename = 'http://localhost/ttbilling/solaimathi/';
    $actual_link = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    define('WEB_ROOTS', $fsitename);
    define('WEB_ROOT', $sitename);
    $docroot = $_SERVER['DOCUMENT_ROOT'] . "/solaimathi/";
} else {
    $db = new PDO('mysql:host=localhost;dbname=solaimathi;charset=utf8mb4', 'solaimathi', 'solaimathi');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "solaimathi", 'solaimathi', "solaimathi");
    $sitename = "https://ttbilling.in/solaimathi/";
    $site = 'https://ttbilling.in/solaimathi/';
    $fsitename = 'https://ttbilling.in/solaimathi/';
